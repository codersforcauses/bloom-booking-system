    ...
    <div className="w-full max-w-md rounded-3xl border border-slate-100 bg-white px-10 py-12 shadow-md">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <div className="space-y-1">
          ...
          <div className="body-sm bloom-input-field flex w-full items-center justify-between outline-none">
            <input
              id="password"
              className="h-full w-full rounded-md px-3 py-2 outline-none placeholder:text-gray-500 disabled:cursor-not-allowed disabled:opacity-50"
