...
import { RoomLocation } from "@/types/room";
...
export default function LocationModal({
  ...
  const [editingItem, setEditingItem] = useState<RoomLocation | null>(null);
  const [confirmDelete, setConfirmDelete] = useState<RoomLocation | null>(null);
  ...
  const handleDelete = async (item: RoomLocation) => {
    try {
