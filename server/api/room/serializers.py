...
class RoomSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        # start_datetime, end_datetime, recurrence_rule can only take default value
        read_only_fields = ['id', 'created_at', 'updated_at', 'start_datetime', 'end_datetime', 'recurrence_rule']
